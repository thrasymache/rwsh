...
void b_scope(const Argm& argm, Error_list& exceptions) {
  ...
  (*argm.argfunction()).prototype_execute(invoking_argm, prototype,
                                                    exceptions);}
...
// before they exit early
void b_set_max_collectible_exceptions(const Argm& argm,
                                      Error_list& exceptions) {
  if (argm.argc() != 2) throw Exception(Argm::Bad_argc, argm.argc()-1, 1, 0);
  if (argm.argfunction()) throw Exception(Argm::Excess_argfunction);
  try {global_stack.max_collect = my_strtoi(argm[1], 1,INT_MAX);}
  catch (E_generic) {throw Exception(Argm::Not_a_number, argm[1]);}
  catch (E_nan) {throw Exception(Argm::Not_a_number, argm[1]);}
  catch (E_range) {throw Exception(Argm::Input_range, argm[1]);}}
...
void b_set_max_extra_exceptions(const Argm& argm, Error_list& exceptions) {
  if (argm.argc() != 2) throw Exception(Argm::Bad_argc, argm.argc()-1, 1, 0);
  if (argm.argfunction()) throw Exception(Argm::Excess_argfunction);
  try {global_stack.max_extra = my_strtoi(argm[1], 0, INT_MAX);}
  catch (E_generic) {throw Exception(Argm::Not_a_number, argm[1]);}
  catch (E_nan) {throw Exception(Argm::Not_a_number, argm[1]);}
  catch (E_range) {throw Exception(Argm::Input_range, argm[1]);}}
...
void b_set_max_nesting(const Argm& argm, Error_list& exceptions) {
  if (argm.argc() != 2) throw Exception(Argm::Bad_argc, argm.argc()-1, 1, 0);
  if (argm.argfunction()) throw Exception(Argm::Excess_argfunction);
  try {global_stack.max_nesting = my_strtoi(argm[1], 0, INT_MAX);}
  catch (E_generic) {throw Exception(Argm::Not_a_number, argm[1]);}
  catch (E_nan) {throw Exception(Argm::Not_a_number, argm[1]);}
  catch (E_range) {throw Exception(Argm::Input_range, argm[1]);}}
...
void b_test_not_empty(const Argm& argm, Error_list& exceptions) {
  if (argm.argc() != 2) throw Exception(Argm::Bad_argc, argm.argc()-1, 1, 0);
  else if (argm.argfunction()) throw Exception(Argm::Excess_argfunction);
